...
plugins {
  ...
  id("org.jlleitschuh.gradle.ktlint") version "12.1.1" // Static code analysis for Kotlin
  id("io.gitlab.arturbosch.detekt") version "1.23.7" // Static code analysis for Kotlin
}
...
// detekt requires a specific kotlin version
